...
export const items: Array<Experience> = [
	...
	},
	{
		...
		location: 'Karachi, Pakistan',
		period: { from: new Date(2021, 12), to: new Date(2023, 4)},
	...
	},
	{
		...
		location: 'Karachi, Pakistan',
		period: { from: new Date(2019, 8), to: new Date(2019, 11)},
		skills: getSkills('php', 'js', 'laravel', 'mysql', 'css', 'html'),
	...
	},
	{
		...
		location: 'Karachi, Pakistan',
		period: { from: new Date(2019, 5), to: new Date(2019, 7)},
		skills: getSkills('php', 'js', 'laravel', 'mysql', 'css', 'html'),
	...
	},
	{
		...
		location: 'Karachi, Pakistan',
		period: { from: new Date(2017, 10), to: new Date(2017, 11)},
		skills: getSkills('php', 'js', 'laravel', 'mysql', 'css', 'html'),
